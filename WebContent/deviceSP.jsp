...
<tr><th>SCREENID:SCDEV01</th><th>DEVICE SIDEPANEL</th><th>USER:</th> <th>Date:<span id="date"></span></th></tr> </table></div>
 <div class="form-style-8">
  ...
  <tr>
   ...
   <input type="text" name="branchid" /></td> </tr>
    ...
    <td><b>SPItem ID </b>
    <input type="text" name="spitemid"  /></td>
    </tr>
    <tr><td><b>SPItem Name</b>
    <input type="text" name="spitemname"  /></td>
    <td><b>SPItem Status </b>
...
<tr><th>Device Id</th><th>SPItemID</th><th>Master(Y)</th><th>MasterID</th><th>Sequence</th><th>Name</th><th>File</th>
<th>STATUS</th></tr>
<tr align="center">
<td>1</td> 
<td>sp123</td> 
...
<div id="myModal" class="modal">
 <!-- Modal content -->
  ...
  <tr><td>ORG ID
    ...
    <tr><td>SP ITEM KEY
    <input type="text" name="spitemkey"  /></td>
    
     <td>SP ITEM MASTER(Y/N)
    <input type="text" name="spitemmaster"  /></td>
    </tr>
    <tr><td>SP ITEM NAME
    <input type="text" name="spitemname"  /></td>
