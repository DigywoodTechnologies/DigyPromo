		...
		<form>
			<table>
				...
				<tr>
					...
					<td><b>MPDItem ID </b> <input type="text" name="mpditemid" /></td>
				</tr>
				<tr>
					<td><b>MPDItem Name</b> <input type="text" name="spitemname" /></td>
					<td><b>MPDItem Status </b> <input type="text" name="spstatus" /></td>
			...
			<div class="form-style-9">
				...
				<form>
					<table>
						...
						<tr>
							<td>MPD ITEM MASTER(Y/N): <input type="checkbox"
								name="mpditemmaster" /></td>

							<td>MPD ITEM KEY: <input type="text" name="mpditemkey" /></td>
						</tr>
						<tr>
							<td>MPD ITEM NAME: <input type="text" name="mpditemname" /></td>

							<td>MPD Duration: <input type="text" name="mpdduration" /></td>
						</tr>
						<tr>
							<td>VALID FROM: <input type="text" name="mpditemstatus" /></td>

							<td>VALID UPTO: <input type="text" name="mpditemstatus" /></td>
						</tr>
						<tr>
							<td>MPD ITEM REMARKS: <input type="text"
								name="mpditemremarks" /></td>

							<td>MPD ITEM STATUS <input type="text" name="mpditemstatus" /></td>
						</tr>
