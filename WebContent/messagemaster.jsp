...
<tr><th>SCREENID:SCDEV01</th><th>MESSAGE MASTER PANEL</th><th>USER:</th> <th>Date:<span id="date"></span></th></tr> </table></div>
 <div class="form-style-8">
  <form>
  <table>
  <tr>
   <td><b>MASTER_MESSAGEID</b>
   <input type="text" name="mmid" id="mmid"/></td>
...
<tr><th>MessageID</th><th>Message Text</th><th>Status</th>
<tr align="center">
     <td>1</td> 
     <td>sp123</td> 
